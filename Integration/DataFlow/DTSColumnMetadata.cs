...
{
    public class DTSColumnMetadata
    {
        #region Properties
        ...
        #region Constructor
        public DTSColumnMetadata(string prefix, PropertyInfo pInfo):
            this(prefix, pInfo, byte.MaxValue)
        {

        }

        public DTSColumnMetadata(string prefix, PropertyInfo pInfo, int maxStringLength)
        {
            ...
            switch (pInfo.PropertyType.ToString())
            {
                ...
                case "System.String":
                    this.DataType = DataType.DT_WSTR;
                    this.Length = this.MaxStringLength;
                    break;
