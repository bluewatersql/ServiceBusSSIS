...
{
    public class SubscriptionEnumerator : IEnumerator
    {
        private SubscriptionClient Connection { get; set; }
        ...
        public SubscriptionEnumerator(MessageClientEntity conn) :
            this(conn, 5, -1, -1, 3, false)
        {

        }

        public SubscriptionEnumerator(MessageClientEntity conn, int timeout, int batch, int maxMessages):
            this(conn, timeout, batch, maxMessages, 3, false)
        {

        }

        public SubscriptionEnumerator(MessageClientEntity conn, int timeout, int batch, int maxMessages, int receiveAttempts, bool autoComplete)
        {
            Connection = (SubscriptionClient)conn;
