...
{
    internal class HandShakeVariableTypeConverter : StringConverter
    {
        ...
        {
            HandShakeGeneralView.GeneralViewNode ddlNode = (HandShakeGeneralView.GeneralViewNode)retrievalObject;
